...
$packages["/home/benny/Entwicklung/gopath/src/github.com/go-on/lib/internal/flight/1_1_4/flight/example/todo/static"] = (function() {
	var $pkg = {}, js = $packages["github.com/gopherjs/gopherjs/js"], main;
	main = function() {
		var inbox, o;
		inbox = (function() {
			this.doSomething = $externalize((function() {
				console.log("did something");
			}), ($funcType([], [], false)));
			this.after($externalize("initialize", $String), $externalize((function() {
				this.on($externalize("click", $String), this.doSomething);
			}), ($funcType([], [], false))));
			console.log(this.attachTo);
		});
		o = $global.flight.component($externalize(inbox, ($funcType([], [], false))));
		o();
	};
	$pkg.$run = function($b) {
...
$error.implementedBy = [$packages["github.com/gopherjs/gopherjs/js"].Error.Ptr, $packages["runtime"].NotSupportedError.Ptr, $packages["runtime"].TypeAssertionError.Ptr, $packages["runtime"].errorString, $ptrType($packages["runtime"].errorString)];
...
$go($packages["/home/benny/Entwicklung/gopath/src/github.com/go-on/lib/internal/flight/1_1_4/flight/example/todo/static"].$run, [], true);
